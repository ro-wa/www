	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td class="desc">
					<?php printf( __( 'If you %screated a custom stylesheet%s and want it to be loaded, select "custom form styles". Otherwise, choose the basic formatting styles or one of the default themes.', 'mailchimp-for-wp' ), '<a href="' . admin_url( 'admin.php?page=mc4wp-pro-form-settings&tab=css-builder' ) .'">', '</a>' ); ?>
				</td>
			</tr>
